...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerPlace = (LinearLayout) findViewById(R.id.pager_place);

        pager = new ScreenPager(this);
        LinearLayout page;
        LayoutInflater inflater = getLayoutInflater();

        for(int i=0; i<6;i++){
            if (i%2 !=0){
                page = (LinearLayout) inflater.inflate(R.layout.old_layout,null);
                TextView tv = (TextView) page.findViewById(R.id.textView_l1);
                tv.setText("Page " + i);
                pager.addScreen(page);
            }
            if (i%2 ==0){
                page = (LinearLayout) inflater.inflate(R.layout.even_layout,null);
                TextView tv = (TextView) page.findViewById(R.id.textView_l2);
                tv.setText("Page " + i);
                pager.addScreen(page);
            }
        }

        pagerPlace.addView(pager);
